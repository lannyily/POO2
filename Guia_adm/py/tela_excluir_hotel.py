...
# Form implementation generated from reading ui file 'tela_excluir_hotel.ui'
#
...
class Ui_tela_excluir_hotel(object):
...
"        }")
        ...
        self.label.setGeometry(QtCore.QRect(20, 110, 181, 21))
        font = QtGui.QFont()
        font.setPointSize(10)
        self.label.setFont(font)
        self.label.setObjectName("label")
        self.lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit.setGeometry(QtCore.QRect(20, 140, 311, 31))
...
"        }")
        ...
        self.lineEdit_2.setGeometry(QtCore.QRect(20, 240, 311, 31))
...
"        }")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label.setText(_translate("MainWindow", "Informe o ID do hotel:"))
        self.pushButton_buscar.setText(_translate("MainWindow", "Buscar"))
        self.label_2.setText(_translate("MainWindow", "Hotel encontrado:"))
